...
//    private $gradientColor = ['#D56767', '#E02828', '#26A2D6', '#40B293', '#69DFDD', '#F28686', '#7D02EB', '#E02828', '#D56767', '#26A2D6'];
    ...
    private $color = ['#3499FF', '#e53efc', '#f9a243', '#46adfe', '#2c80ff', '#e23cfd', '#7D02EB', '#8D5B4C', '#F86624', '#2E294E'];
    private $gradientColor = ['#6C25FB', '#ff7179', '#654ae8', '#f8576f', '#31317a', '#fe6f7e', '#7D02EB', '#E02828', '#D56767', '#26A2D6'];
    ...
    protected function render()
    {
        ...
        if (isGraphinaPro() && $settings['iq_' . $type . '_chart_data_option'] !== 'manual') {
            ...
            foreach ($categoryList as $v) {
                $data["category"][] = $v['iq_' . $type . '_chart_category'];
            }
            for ($i = 0; $i < $seriesCount; $i++) {
                ...
                foreach ($valueList as $v) {
                    $value[] = $v['iq_' . $type . '_chart_value_4_' . $i];
                }
                $data['series'][] = [
                    'name' => $settings['iq_' . $type . '_chart_title_4_' . $i],
                    'data' => $value,
        ...
        <script>
            ...
            var columnOptions = {
                ...
                dataLabels: {
                    ...
                    offsetY: <?php echo $datalables_offset_y ?>,
                    offsetX: <?php echo $datalables_offset_x ?>,
                    style: {
