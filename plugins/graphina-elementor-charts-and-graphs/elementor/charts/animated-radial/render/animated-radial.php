    ...
    <div class="">
        <?php if ($settings['iq_animated-radial_is_card_heading_show'] && $settings['iq_animated-radial_chart_card_show']) { ?>
            <h4 class="heading graphina-chart-heading"
                style="text-align: <?php echo $settings['iq_animated-radial_card_title_align']; ?>; color: <?php echo strval($settings['iq_animated-radial_card_title_font_color']);?>"><?php echo $settings['iq_animated-radial_chart_heading']; ?></h4>
        <?php }
        if ($settings['iq_animated-radial_is_card_desc_show'] && $settings['iq_animated-radial_chart_card_show']) { ?>
            <p class="sub-heading graphina-chart-sub-heading"
               style="text-align: <?php echo $settings['iq_animated-radial_card_subtitle_align']; ?>; color: <?php echo strval($settings['iq_animated-radial_card_subtitle_font_color']);?>;"><?php echo $settings['iq_animated-radial_chart_content']; ?></p>
        <?php } ?>
    </div>
