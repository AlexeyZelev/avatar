    ...
    protected function render()
    {
        ...
        if (isGraphinaPro() && $settings['iq_' . $type . '_chart_data_option'] !== 'manual') {
            ...
            for ($i = 0; $i < $seriesCount; $i++) {
                ...
                foreach ($valueList as $v) {
                    $value[] = $v['iq_' . $type . '_chart_value_3_' . $i];
                }
                $data['series'][] = [
        ...
        <script>
            ...
            var radarOptions = {
                ...
                stroke: {
                    width: <?php echo $settings['iq_' . $type . '_chart_stroke_size'] ?>
                },
                colors: '<?php echo $gradient; ?>'.split('_,_'),
                markers: {
                    size: <?php echo $settings['iq_' . $type . '_chart_marker_options'] === 'yes' ? $settings['iq_' . $type . '_chart_marker_size'] : 0 ?>,
                    colors: ['<?php echo $settings['iq_' . $type . '_chart_marker_color'] ?>'],
                    strokeColor: '<?php echo $settings['iq_' . $type . '_chart_marker_stroke_color'] ?>',
                    strokeWidth: <?php echo $settings['iq_' . $type . '_chart_marker_stroke_width'] ?>,
                },
                xaxis: {
